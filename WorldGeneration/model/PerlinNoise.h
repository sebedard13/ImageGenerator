...
template<typename T>
auto octavesPerlin(T x, unsigned int octaves, T persistence) -> T;

template<typename T>
auto perlin(T x, T y) -> T;

template<typename T>
auto octavesPerlin(T x, T y, unsigned int octaves, T persistence) -> T;

template<typename T>
auto perlin(T x, T y, T z) -> T;

template<typename T>
auto octavesPerlin(T x, T y, T z, unsigned int octaves, T persistence) -> T;
...
template<typename T>
T octavesPerlin(T x, T y, T z, unsigned int octaves, T persistence)
{
	T total = 0;
	T frequency = 1;
	T amplitude = 1;
	T maxValue = 0;  // Used for normalizing result to 0.0 - 1.0
...
template<typename T>
T octavesPerlin(T x, T y, unsigned int octaves, T persistence)
{
	T total = 0;
	T frequency = 1;
	T amplitude = 1;
...
template<typename T>
T octavesPerlin(T x, unsigned int octaves, T persistence)
{
	T total = 0;
	T frequency = 1;
	T amplitude = 1;
...
template auto octavesPerlin<float>(float x, unsigned int octaves, float persistence) -> float;
template auto octavesPerlin<float>(float x, float y, unsigned int octaves, float persistence) -> float;
template auto octavesPerlin<float>(float x, float y, float z, unsigned int octaves, float persistence) -> float;


template auto octavesPerlin<double>(double x, unsigned int octaves, double persistence) -> double;
template auto octavesPerlin<double>(double x, double y, unsigned int octaves, double persistence) -> double;
template auto octavesPerlin<double>(double x, double y, double z, unsigned int octaves, double persistence) -> double;